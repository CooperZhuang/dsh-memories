 ...
 * declare fails the save — so the two lists must stay in step. This checks them
 * as text, which is also how the host sees the card.
 *
...
import { MEMORIES_SETTINGS_DEFAULTS } from '../config.js'
